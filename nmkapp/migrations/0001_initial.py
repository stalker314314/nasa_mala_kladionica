# Generated by Django 2.0.3 on 2018-05-23 11:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_key', models.CharField(blank=True, max_length=8)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='owner', to=settings.AUTH_USER_MODEL)),
                ('players', models.ManyToManyField(related_name='nmkgroup', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Match',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reset_code', models.CharField(blank=True, max_length=255)),
                ...
                ('odd_format', models.IntegerField(choices=[(1, 'Decimal (European)'), (2, 'Fractional (UK)')], default=1)),
