...
class ResetPasswordTests(NmkUnitTestCase):
    def test_no_reset_code(self):
        ...
        self.assertTrue('username' not in context)
    ...
    def test_land_reset_password(self):
        ...
        self.assertEqual(response.status_code, 200)
        reset_code = models.Player.objects.filter(user__username='kokan')[0].reset_code
    ...
    def test_reset_password(self):
        ...
        self.assertTrue(self.client.login(username='kokan', password='newpass'))
